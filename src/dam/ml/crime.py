...
class CrimeService:
    ...
    def __init__(self):
        ...
        self.pop = pd.read_excel('../../../static/data/dam/ml/pop_in_seoul.xls',usecols=["자치구","합계","한국인","등록외국인","65세이상고령자"], skiprows=[0,2])
        self.ls = [self.crime, self.cctv, self.pop]
        self.crime_rate_columns = ['살인검거율', '강도검거율', '강간검거율', '절도검거율', '폭력검거율']
        self.crime_columns = ['살인', '강도', '강간', '절도', '폭력']
        self.arrest_columns = ['살인 검거', '강도 검거', '강간 검거', '절도 검거', '폭력 검거']
        self.us_states = '../../../static/data/dam/ml/us-states.json'
        self.us_unemployment = pd.read_csv('../../../static/data/dam/ml/us_unemployment.csv')
        self.kr_states = '../../../static/data/dam/ml/kr-state.json'
    ...
    def save_police_pos(self): # 2
        ...
        crime.to_pickle('../../../static/save/ml/police_pos.pkl')
        print(pd.read_pickle('../../../static/save/ml/police_pos.pkl'))
    ...
    def save_cctv_pop(self): # 3
        ...
        print(pd.read_pickle('../../../static/save/ml/cctv_pop.pkl'))

    def save_police_norm(self): # 4
        police_pos = pd.read_pickle('../../../static/save/ml/police_pos.pkl')
        ...
        print(pd.read_pickle('../../../static/save/ml/police_norm.pkl'))

    def save_us_unemployment_map(self): # 5
        mc = MyChoroplethVO()
        mc.geo_data = self.get_json_from_df("./data/us-states.json")
    ...
    def get_seoul_crime_data(self):
        police_pos = pd.read_pickle('../../../static/save/ml/police_pos.pkl')
        police_norm = pd.read_pickle('../../../static/save/ml/police_norm.pkl')
    ...
    def get_json_from_df(self,fname):
        df = pd.read_json(fname)  ## pd.read_json 이용
        '''## orient
